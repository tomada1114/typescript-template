...
- `CONTRIBUTING.md`: local setup, the main `pnpm` commands, how to run
  tests, release intent, and the PR process.
- `CHANGELOG.md`: Keep a Changelog categories and SemVer. Release pull requests
  update it and it is Prettier-ignored for that reason — keep entries focused on
  published changes.
